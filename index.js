...
//   const halls=await client.db("hallbooking").collection("rooms").find({}).toArray();
//   res.send(halls);
// });
// //post hall

// app.post("/hall",express.json(),async function(req,res){
//     const data=req.body;
...
//   hall ? res.send(hall) : res.status(404).send({ msg: "hall not found" });
// });
